    ...
    def get_driver(self) -> WebDriver:
        ...
        try:
            if browser_type == 'chrome':
                ...
                service = ChromeService(driver_path, service_args=service_args if service_args else None)
                ...
                service = FirefoxService(driver_path, service_args=service_args if service_args else None)
